...
return {
    link: function (scope, element, attrs) {
      ...
      scope.$on('add_specialty', function(event, skill_id) {
        ...
        $('[data-id="' + skill_id + '"]').parent().append(html);
      });
          ...
          angular.forEach(row.groups, function (group, index) {
            ...
            if ('skills' in group) {
              angular.forEach(group.skills, function (skill, index) {
                ...
                html += '<div class="list-item skill"><span class="skill_name" data-id="' + skill.id + '" ng-click="add_specialty(' + skill.id + ')" title="Click to add Specialty">' + skill.name + '</span>';
